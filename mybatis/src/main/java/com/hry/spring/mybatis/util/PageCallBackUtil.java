...
import im.yixin.icc.common.exception.DaoException;
import im.yixin.icc.domain.common.constants.IRespCode;
import im.yixin.icc.domain.common.dto.AbstractQry;
...
public class PageCallBackUtil {
    ...
    public static<T>  MyPage<T> selectRtnPage(AbstractQry qry, IPageHelperPageCallBack callBack){
        ...
        if(!(list instanceof Page)){
            throw new DaoException(IRespCode.CODE_INTERNAL_ERROR, "list must be 'com.github.pagehelper.Page', now is " + list.getClass().getCanonicalName());
        }
